...
(defun class-name-direct-superclasses (class-name)
  (mapcar #'class-name (mop:class-direct-superclasses (find-class class-name))))
...
(defun class-name-precedence-list (class-name)
  ...
  (or
   (let ((class (find-class class-name)))
     (when (mop:class-finalized-p class)
       (mapcar #'class-name (mop:class-precedence-list class))))
   (delete-duplicates
    (apply #'append
	   (list class-name)
